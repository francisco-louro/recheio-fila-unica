var DateUtil = (function () {
    ...
    function formatDate(format, separator, elem) {
        ...
        for (var f in formatDateRequired) {
            ...
            switch(formatDateRequired[[f]]) {
                ...
                case 'ww':
                    formatedDate += getWeekdayFormat() + sep;
                    break;
                case 'w':
                    formatedDate += getWeekdayFormat(true) + sep;
                    break;
                case 'd':
    ...
    return {
        ...
        getDateFormated: function(format, separator, elem) {

            dateElem = document.getElementById(elem);
            if(!dateElem) dateElem = document.getElementsByClassName(elem)[0];

            dateInterval = setInterval( function(){ formatDate(format, separator, elem); }, updateDateInterval * 1000);
        },
